/**
 * jspsych-html-slider-response-adap
...
jsPsych.plugins['html-slider-response-adap'] = (function() {

  var plugin = {};

  plugin.info = {
    name: 'html-slider-response-adap',
    description: '',
    parameters: {
      stimulus: {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    display_element.querySelector('#jspsych-html-slider-response-next').addEventListener('click', function() {
      ...
      response.rt = changeTime - startTime;
      response.rt_btn = endTime - startTime;
